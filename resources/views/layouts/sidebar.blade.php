<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Hotel Transylvania</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}" href="{{ route('dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('user/edit/' . Auth::user()->id) ? 'active' : '' }}" href="{{ route('user.edit', ['user' => Auth::user()->id]) }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if(Auth::user()->role  == "admin")
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('room/checkin') ? 'active' : '' }}"  href="{{ url('room/checkin') }}">
                        ...
                        <span class="nav-link-text ms-1">Check In/Out</span>
                    </a>
                </li>
            @endif
        </ul>
